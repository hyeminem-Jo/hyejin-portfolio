        ...
        <S.AboutInner>
          <S.AboutInnerBoxTitleInner>
            ...
            <S.AboutInnerBoxDesc>
              ...
              <strong>미세한 감각과 인터랙션의 디테일</strong>을 정확하게 파악하고 구현하여 '기대
              이상'이라는 평가를 받은 경험이 많습니다. 저는 직관적으로 좋아보이는 결과물이{' '}
              <strong>더 나은 사용자 경험</strong>으로 이어지도록 주도적으로 고민합니다. 실제로
              디자인 및 기획 회의 중 내용의 모순점이나 개선점을 발견했을 때, 능동적으로 의견을
              제시하여 <i>"그거 괜찮은데요? 혜진님 말씀대로 수정하는 게 더 나을 것 같아요"</i> 라는
