...
const skillDescList = [
  ...
  'SSR 환경의 경우 Next.js 서버 컴포넌트를 활용한 API 라우터 최소화 및 SEO 대응하였으며, App Router를 활용하여 라우팅 구조를 개선하였습니다.',
  ...
  'React-Hook-Form 및 yup 을 활용하여 유효성 체크 및 효율적인 폼 관리를 구현하였습니다.',
  ...
  '개인프로젝트에서 Supabase를 활용하여 더욱 쉽고 간단한 백엔드 환경을 경험하였으며 데이터베이스를 구현하였습니다. \n배포의 경우 Vercel을 활용하여 간편한 배포를 구현하였습니다.',
];
